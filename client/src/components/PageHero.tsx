...
export function PageHero({
  ...
  return (
    <section className="page-hero relative isolate overflow-hidden pt-8 sm:pt-12">
      ...
      <div className="container pb-18 pt-8 sm:pb-20 lg:pb-24 lg:pt-14">
        <div
          className={cn(
            "grid gap-8",
            aside ? "lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-end" : "lg:grid-cols-[minmax(0,56rem)]"
          )}
        >
